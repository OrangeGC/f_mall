        ...
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
              ...
              <router-link to="/thanks">赞助</router-link>
            </div>
            ...
            <div class="nav-aside">
              ...
              <!-- 购物车 -->
              <!-- vue鼠标移入移出事件 @mouseenter，@mouseleave-->
              <div class="shop pr" @mouseenter="cartListShow(true)" @mouseleave="cartListShow(false)">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell">
                                      ...
                                      <h6>
                                        ...
                                        <span class="price-num">44444</span>
                                        <span class="item-num"
                                          >x productnum</span
                                        >
                                      </h6>
